// Vendored from the Zig 0.15.2 standard library: std.SegmentedList was
// removed from std in 0.16.0, but this project relies on its pointer
// stability guarantee (component storage keeps raw pointers into it).
